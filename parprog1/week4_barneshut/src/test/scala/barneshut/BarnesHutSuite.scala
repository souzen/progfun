...
class BarnesHutSuite extends FunSuite {
  ...
  test("'SectorMatrix.+=' should add a body at (102,102) to the correct bucket of a sector matrix of size 96") {
    val body = new Body(5, 102, 102, 0.1f, 0.1f)
    val boundaries = new Boundaries()
    boundaries.minX = 1
    boundaries.minY = 1
    boundaries.maxX = 97
  ...
  test("'SectorMatrix.+=' should add a body at (-12,-12) to the correct bucket of a sector matrix of size 96") {
    val body = new Body(5, -12, -12, 0.1f, 0.1f)
    val boundaries = new Boundaries()
    boundaries.minX = 1
    boundaries.minY = 1
    boundaries.maxX = 97
